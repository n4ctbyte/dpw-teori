...
<body class="bg-cream text-brown font-sans h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border border-terra/20">
        ...
        <form action="{{ url('tambah_tamu') }}" method="POST" class="flex flex-col gap-4">
            @csrf
            <div>
            ...
            <div class="flex gap-3 mt-4">
                ...
                <button type="submit" class="w-1/2 bg-terra text-white py-2 rounded-lg font-medium hover:bg-terra2 transition">Simpan</button>
            </div>
        </form>
    </div>
</body>
