...
<body class="bg-cream text-brown font-sans h-screen flex items-center justify-center p-4">
    <div class="bg-terra w-full max-w-[480px] rounded-xl p-6 sm:p-8 md:p-12 text-center shadow-lg">
        ...
        <form action="{{ url('login') }}" method="POST">
            ...
            <button type="submit" name="login" class="w-full bg-cream text-brown font-bold tracking-widest rounded-full px-6 py-3.5 hover:bg-orange-50 transition-colors text-sm shadow-sm">MASUK</button>
        </form>
    </div>
</body>
</html>