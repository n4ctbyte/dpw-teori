...
<head>
    ...
    <title>Tambah Tamu - Nakata & Sari</title>
...
<body class="bg-cream text-brown font-sans h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border border-terra/20">
        <h2 class="font-serif text-2xl font-bold text-center mb-6 text-brown">Tambah Data Tamu</h2>
        
        <form action="" method="POST" class="flex flex-col gap-4">
            <div>
                <label class="block text-sm font-medium mb-1">Nama Tamu</label>
                <input type="text" name="nama" required class="w-full bg-cream border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-terra" placeholder="Masukkan nama...">
            </div>
            ...
            <div>
                ...
                <select name="kehadiran" required class="w-full bg-cream border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-terra">
                    ...
                    <option value="belum" selected>Belum Respon</option>
                </select>
            </div>

            <div>
                <label class="block text-sm font-medium mb-1">Pesan / Ucapan</label>
                <textarea name="pesan" rows="3" class="w-full bg-cream border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-terra" placeholder="Tulis pesan..."></textarea>
            </div>
            ...
            <div class="flex gap-3 mt-4">
                ...
                <button type="submit" name="submit" class="w-1/2 bg-terra text-white py-2 rounded-lg font-medium hover:bg-terra2 transition">Simpan</button>
            </div>
        </form>
    </div>
</body>
